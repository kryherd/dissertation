...
ggplot(ashby_dat, aes(nd_tf, ashby.t)) + geom_point() + theme_bw() + facet_grid(.~System) + stat_smooth(method = "lm", se = FALSE) + ggtitle("Relationships Between Vocab and COVIS Accuracy") + xlab("Nelson-Denny Vocab (scaled)") + ylab("COVIS Accuracy (scaled)")
...
ggplot(tt_dat, aes(tol_acc_tf, tt.t)) + geom_point(alpha = 0.25) + theme_bw() + stat_smooth(se = FALSE, method = "lm") + xlab("Tower of London Accuracy (scaled))") + ylab("TT Accuracy (scaled)") + ggtitle("Significant main effect of planning on TT accuracy")
...
ggplot(ashby_dat, aes(nd_tf, ashby.t)) + geom_point() + theme_bw() + facet_grid(.~System) + stat_smooth(method = "lm", se = FALSE)  + ggtitle("Relationships Between Vocab and COVIS RT") + xlab("Nelson-Denny Vocab (scaled)") + ylab("COVIS RT (scaled)")
...
ggplot(sloutsky_dat, aes(tol_time_tf, sloutsky.t)) + geom_point() + theme_bw() + stat_smooth(se = FALSE, method = "lm") + ggtitle("Relationships Between ToL and Statistical Density RT") + xlab("Tower of London Accuracy (scaled)") + ylab("Statistical Density RT (scaled)") + facet_grid(.~System)
...
ggplot(tt_dat, aes(flanker_eff_cs, tt.t)) + geom_point() + theme_bw() + stat_smooth(se = FALSE, method = "lm") + ggtitle("Relationships Between Flanker Effect and TT RT") + xlab("Flanker Effect (scaled)") + ylab("TT RT (scaled)") + facet_grid(.~System)
