...
slout_rt_stand$System[slout_rt_stand$Block == "UnupervisedSparse"] <- "hypothesis-testing"
# column for paradigm
...
There's no main effect of CatLearn, suggesting that average (standardized) ACC across models is the same. The results are really showing a ceiling effect -- we don't see many differences between HT and AS for sloutsky and tax-them because they're easy! So, we can look at RT instead.
