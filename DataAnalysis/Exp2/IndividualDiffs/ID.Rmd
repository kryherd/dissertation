...
ashby2 <- read.csv("Ashby_concat_03-01-19_1728.csv")
colnames(ashby1)[3] <- "Run"
colnames(ashby1)[6] <- "key_pressed"
ashby <- rbind(ashby1,ashby2)
sloutsky <- read.csv("Sloutsky_concat_03-01-19_1729.csv")
taxthem <- read.csv("taxthem_concat_03-01-19_1729.csv")
tol <- read.csv("tol_concat_03-01-19_1731.csv")
switcher <- read.csv("switcher_concat_03-01-19_1731.csv")
flanker <- read.csv("flanker_concat_03-01-19_1731.csv")
ravens <- read.csv("ravens_3-1-19.csv")
