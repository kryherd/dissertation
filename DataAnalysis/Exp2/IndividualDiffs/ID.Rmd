...
#anova(m1,m2)
#anova(m2)
m3 <- lmer(ashby.t ~ System + ravens_tf + flanker_eff_cs + switch_eff_tf + tol_time_tf + nd_tf  + (1|Subject), data = ashby_dat)
anova(m1,m3)
anova(m3)
m4 <- lmer(ashby.t ~ ravens_tf + System * (flanker_eff_cs + switch_eff_tf + tol_time_tf + nd_tf) + (1|Subject), data = ashby_dat)
anova(m3,m4)
anova(m4)
...
anova(m1,m3)
anova(m3)
m4 <- lmer(sloutsky.t ~ ravens_tf + System * (flanker_eff_cs + switch_eff_tf + tol_time_tf + nd_tf) + (1|Subject), data = sloutsky_dat)
anova(m3,m4)
anova(m4)
...
ggplot(tt_dat, aes(ravens_tf, tt.t)) + geom_point(alpha = 0.25) + theme_bw() + stat_smooth(se = FALSE, method = "lm") + xlab("Nonverbal IQ") + ylab("TT Accuracy") + ggtitle("Significant main effect of nonverbal IQ on TT accuracy")
...
ggplot(sloutsky_dat, aes(tol_time_tf, sloutsky.t)) + geom_point() + theme_bw() + stat_smooth(se = FALSE, method = "lm") + xlab("Tower of London Planning Ratio") + ylab("Sloutsky Reaction Time") + ggtitle("Significant main effect of ToL on Sloutsky RT")
