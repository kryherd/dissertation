...
ashby2 <- read.csv("Ashby_concat_02-27-19_1618.csv")
colnames(ashby1)[3] <- "Run"
colnames(ashby1)[6] <- "key_pressed"
ashby <- rbind(ashby1,ashby2)
sloutsky <- read.csv("Sloutsky_concat_02-27-19_1618.csv")
taxthem <- read.csv("taxthem_concat_02-27-19_1619.csv")
tol <- read.csv("tol_concat_02-27-19_1637.csv")
switcher <- read.csv("switcher_concat_02-27-19_1637.csv")
flanker <- read.csv("flanker_concat_02-27-19_1637.csv")
ravens <- read.csv("ravens_2-27-19.csv")
...
anova(m1,m3)
anova(m3)
m4 <- lmer(tt.t ~ ravens_tf + System * (flanker_eff_cs + switch_eff_tf + tol_time_tf + nd_tf) + (1|Subject), data = tt_dat)
anova(m3,m4)
anova(m4)
