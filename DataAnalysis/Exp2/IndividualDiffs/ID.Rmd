...
ashby2 <- read.csv("Ashby_concat_03-07-19_0936.csv")
colnames(ashby1)[3] <- "Run"
colnames(ashby1)[6] <- "key_pressed"
ashby <- rbind(ashby1,ashby2)
sloutsky <- read.csv("Sloutsky_concat_03-07-19_0936.csv")
taxthem <- read.csv("taxthem_concat_03-07-19_0936.csv")
tol <- read.csv("tol_concat_03-07-19_0937.csv")
switcher <- read.csv("switcher_concat_03-07-19_0937.csv")
flanker <- read.csv("flanker_concat_03-07-19_0937.csv")
ravens <- read.csv("ravens_3-7-19.csv")
